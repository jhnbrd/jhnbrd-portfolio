            ...
            {activeTab === 'overview' && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-fade-in">
                <div className="lg:col-span-7 flex flex-col gap-4">
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 rounded-sm bg-primary/10 text-primary text-xs font-mono font-semibold border border-primary/30 uppercase tracking-wide">
                      Philosophy &amp; Focus
                    </span>
                    <span className="text-xs font-mono text-muted-foreground">Systems-First Engineering</span>
                  </div>
                  ...
                  <div className="flex flex-col gap-3 text-sm text-muted-foreground leading-relaxed">
                    <p>
                      As Co-Founder &amp; Backend Developer at <strong className="text-foreground font-semibold">DevJunction</strong>, I turn complex business requirements into high-throughput REST APIs, normalized relational databases, and containerized deployment workflows.
                    </p>
                    <p>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
                    <div className="p-3.5 bg-background border border-border rounded-sm flex flex-col gap-1">
                      <span className="text-primary text-xs font-bold font-mono">Backend Core</span>
                      <span className="text-xs text-muted-foreground">Laravel · .NET 8 · FastAPI</span>
                    </div>
                    <div className="p-3.5 bg-background border border-border rounded-sm flex flex-col gap-1">
                      <span className="text-primary text-xs font-bold font-mono">Persistence</span>
                      <span className="text-xs text-muted-foreground">MySQL · PostgreSQL · MS SQL</span>
                    </div>
                    <div className="p-3.5 bg-background border border-border rounded-sm flex flex-col gap-1">
                      <span className="text-primary text-xs font-bold font-mono">Infrastructure</span>
                      <span className="text-xs text-muted-foreground">Cloudflare WAF · Linux · CI/CD</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:col-span-5 flex flex-col gap-4 bg-background/80 border border-border rounded-sm p-5 font-mono">
                  ...
                  <div className="space-y-3 text-xs">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-foreground font-semibold">DevJunction Inc.</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Active Role</span>
                      <span className="text-primary font-medium">Co-Founder / Backend</span>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex flex-col items-end gap-1">
                          <span className="text-xs text-primary font-mono bg-primary/10 border border-primary/20 px-2 py-0.5 rounded-sm font-semibold">
                            {exp.type}
                          </span>
                      ...
                      <div className="flex flex-col gap-0.5">
                        {exp.url ? (
                          <a
                            ...
                            className="text-sm font-bold text-foreground group-hover:text-primary transition-colors inline-flex items-center gap-1"
                          >
                            <span>{exp.org}</span>
                        ...
                        <span className="text-xs text-primary font-mono font-medium">{exp.role}</span>
                      </div>
            ...
            {activeTab === 'infrastructure' && (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-fade-in">
                ...
                <div className="lg:col-span-5 flex flex-col gap-3">
                  <div className="text-xs font-mono text-muted-foreground uppercase tracking-widest font-semibold">
                  ...
                  {machines.map((m) => (
                    <div key={m.name} className="p-4 bg-background border border-border rounded-sm flex flex-col gap-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-mono text-success font-bold">● ACTIVE</span>
                      </div>
                      <span className="text-xs text-primary font-mono">{m.specs}</span>
                ...
                <div className="lg:col-span-7 flex flex-col gap-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-success font-mono font-bold">● WAF Active</span>
                  </div>
                  <div className="grid grid-cols-1 gap-2.5">
                    {homelab.tunnels.map((t) => (
                      <div
                        key={t.subdomain}
                        className="flex items-center justify-between p-3.5 bg-background border border-border rounded-sm font-mono text-xs"
                      >
                  ...
                  <div key={edu.id} className="p-6 bg-background border border-border rounded-sm flex flex-col justify-between gap-4 group">
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <span className="text-xs text-primary font-mono font-medium">{edu.degree}</span>
                        {edu.honors && (
                          <span className="text-xs text-success font-bold font-mono mt-0.5">
                            ★ {edu.honors}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="pt-3 border-t border-border/40">
                      <span className="text-xs text-muted-foreground uppercase tracking-wider font-mono block mb-2 font-semibold">
                        Focus Coursework
                      </span>
                      <div className="flex flex-wrap gap-1.5">
                        {edu.courses.map((c) => (
                          <span key={c} className="text-xs bg-surface border border-border px-2.5 py-1 rounded-sm text-foreground/90 font-mono">
                            {c}
                          </span>
                        ))}
                      </div>
