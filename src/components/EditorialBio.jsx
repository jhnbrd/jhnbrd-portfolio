...
export default function EditorialBio({ personal }) {
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-5 sm:px-12 w-full">
        <motion.div
        ...
        >
          ...
          <motion.div 
            variants={itemVariants}
            className={`w-full pt-4 mb-8 sm:mb-12 ${isDark ? 'border-t border-neutral-800' : 'border-t border-neutral-200'}`}
          >
