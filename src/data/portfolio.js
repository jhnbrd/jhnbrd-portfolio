export const personal = {
  ...
  subtitle: 'Backend Developer · Systems & Infrastructure · Davao City, PH',
  tagline: 'Backend Architect · Cloud Systems · DevJunction',
...
export const featuredProjects = [
  {
    ...
    tags: ['Node.js', 'PostgreSQL', 'PostGIS', 'TensorFlow.js', 'React'],
    status: 'in-dev',
    year: '2026',
  ...
  },
  {
    ...
    tags: ['C# .NET 8', 'MS SQL Server', 'REST APIs', 'React'],
    status: 'in-dev',
    year: '2026',
    role: 'Backend Developer',
...
export const experience = [
  {
    ...
    bullets: [
      'Engineered custom web platforms, high-throughput backend systems, and client software solutions.',
